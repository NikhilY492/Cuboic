                        ...
                        <View style={[styles.card, {
                            ...
                            <View style={styles.logoArea}>
                                <View style={[styles.logoRing, { borderColor: colors.accent + '50', backgroundColor: colors.surface2 }]}>
                                    <Image
                                        source={require('../../../assets/images/onomex_logo.png')}
                                        style={styles.logoImage}
                                    />
                                </View>
                                <Text style={[styles.appName, { color: colors.accent, fontFamily: fontsLoaded ? 'Orbitron_400Regular' : undefined }]}>ONOMEX</Text>
