...
import onomexIcon from "../../assets/pic1.png";
        ...
        <div className="flex justify-between items-center relative">
          ...
          <Link to="/" className="flex items-center gap-3">
            <motion.img 
              ...
              src={onomexIcon} alt="Onomex Icon" className="w-12 h-12 object-contain" 
            />
            <span className="font-extrabold text-2xl tracking-tight text-white">ONOMEX</span>
          </Link>
        ...
        >
          <div className="px-4 pt-2 pb-4 space-y-1">
            ...
            <button className="w-full mt-2 bg-lime-600 hover:bg-lime-500 text-black px-5 py-3 rounded-xl font-bold shadow-md transition-colors flex items-center justify-center gap-3">
              Book a demo
              <img alt="Onomex Icon" className="w-7 h-7 object-contain" src="/src/assets/pic1.png" />
            </button>
          </div>
        </motion.div>
      )}
