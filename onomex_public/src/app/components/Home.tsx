          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-lime-900/30 text-lime-400 font-medium mb-6 border border-lime-600/30 backdrop-blur-md">
                ...
                Meet Onomex. The Future of Dining.
              </div>
            ...
            >
              ...
              <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[85%] rounded-3xl overflow-hidden shadow-2xl shadow-amber-500/10 border border-slate-800 bg-[#0a0a0a] backdrop-blur-xl p-2">
                <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden bg-black">
                  <ImageWithFallback src={heroImg} alt="Onomex Ecosystem" className="w-full h-full object-cover opacity-80 hover:opacity-100 transition-opacity" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-400">
              Onomex provides a fully integrated suite of services that communicate seamlessly, creating an unmatched dining experience for your guests and a highly profitable model for you.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="bg-[#0a0a0a]/90 backdrop-blur-2xl rounded-3xl p-8 shadow-xl relative border border-slate-800">
                <h3 className="text-2xl font-bold text-white mb-6">The Onomex Workflow</h3>
      ...
      <section className="py-24 relative overflow-hidden bg-black">
        ...
        >
          ...
          <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
            Join hundreds of visionary restaurants leveraging Onomex to slash wait times, delight customers, and boost their bottom line.
          </p>
