...
export function CheckoutPage() {
    ...
    const handlePay = async () => {
        ...
        try {
            ...
            localStorage.removeItem('onomex_cart');

            // Save order history array
            try {
                const stored = localStorage.getItem('onomex_active_orders');
                ...
                localStorage.setItem('onomex_active_orders', JSON.stringify([...prevOrders, newOrderSession]));
            } catch (err) {
        ...
        <div className="checkout-page fade-in">
            <header className="checkout-header">
                <div className="container">
                    ...
                    <p className="checkout-brand">Onomex</p>
                </div>
            </header>
