...
export function MenuPage() {
    ...
    useEffect(() => {
        ...
        try {
            const o = localStorage.getItem('onomex_active_orders');
            if (o) {
                ...
                if (validOrders.length !== parsed.length) {
                    if (validOrders.length === 0) {
                        localStorage.removeItem('onomex_active_orders');
                    } else {
                        localStorage.setItem('onomex_active_orders', JSON.stringify(validOrders));
                    }
                }
            }
        } catch (e) {
                ...
                <header className="menu-header">
                    <div className="menu-header__inner">
                        <div className="menu-header__brand">
                            <img src="/pic1.png" className="menu-header__logo" alt="Onomex" />
                            <div>
                                <div className="menu-header__name">{restaurantName}</div>
                                <div className="menu-header__sub">Onomex</div>
                            </div>
                        </div>
                    </div>
                </header>
            ...
            <footer className="menu-footer">
                <div className="menu-footer__inner">
                    <div className="menu-footer__brand">
                        <img src="/pic1.png" className="menu-footer__logo" alt="Onomex Logo" />
                        <span className="menu-footer__wordmark">Onomex</span>
                    </div>
                    <p className="menu-footer__tagline">
                        Autonomous restaurant delivery, powered by robots.
                    </p>
                    <div className="menu-footer__links">
                        <a href="mailto:support@onomex.in">support@onomex.in</a>
                        <span className="menu-footer__dot">·</span>
                        <a href="https://onomex.in" target="_blank" rel="noopener noreferrer">onomex.in</a>
                        <span className="menu-footer__dot">·</span>
                        <span>Kerala, India</span>
                    </div>
                    <p className="menu-footer__copy">© {new Date().getFullYear()} Onomex Networks Pvt. Ltd. All rights reserved.</p>
                </div>
            </footer>
