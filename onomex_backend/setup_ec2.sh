...
# Configure Nginx
sudo cp nginx.conf /etc/nginx/sites-available/onomex
sudo ln -s /etc/nginx/sites-available/onomex /etc/nginx/sites-enabled/
...
echo "Setup Complete!"
echo "Next Steps:"
echo "1. Run 'sudo certbot --nginx -d onomex.in -d api.thambi.in' to enable SSL."
