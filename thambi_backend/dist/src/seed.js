...
async function seed() {
    ...
    const menuItemsData = [
        {
            name: 'Medu Vadai',
            description: 'Crispy urad dal doughnuts, served with sambar & coconut chutney',
            price: 80,
            cat: 0,
            image: IMG.vadai,
        },
        {
            name: 'Idli Sambar',
            description: 'Three steamed rice cakes with aromatic sambar & three chutneys',
            price: 70,
            cat: 0,
            image: IMG.idli,
        },
        {
            name: 'Mysore Bonda',
            description: 'Fluffy deep-fried urad dal balls with ginger & curry leaves',
            price: 80,
            cat: 0,
        ...
        {
            name: 'Masala Papadum',
            description: 'Roasted papadums with raw mango, onion & green chilli topping',
            price: 60,
            cat: 0,
            image: IMG.papadum,
        },
        {
            name: 'Rasam',
            description: 'Thin tangy tomato-tamarind pepper broth — the South Indian soul',
            price: 60,
            cat: 0,
            image: IMG.rasam,
        },
        ...
        {
            name: 'Masala Dosa',
            description: 'Crispy rice-lentil crepe folded over spiced potato & onion filling',
            price: 130,
            cat: 1,
            image: IMG.dosa,
        },
        {
            ...
            description: 'Paper-thin dosa finished with generous ghee, served with chutneys',
            price: 150,
            cat: 1,
        ...
        {
            name: 'Avial',
            description: 'Mixed vegetables in a thick coconut-curd gravy, tempered with coconut oil',
            price: 170,
            cat: 1,
        ...
        },
        {
            ...
            description: 'Andhra-style green moong dal tempered with dry red chilli & ghee',
            price: 160,
            cat: 1,
            image: IMG.palakDal,
        },
        {
            name: 'Kothu Parotta',
            description: 'Shredded layered parotta stir-fried with egg, onion & spiced gravy',
            price: 210,
            cat: 1,
        ...
        },
        {
            ...
            description: '7-item unlimited thali — rice, dal, sambar, rasam, 2 curries, curd',
            price: 220,
            cat: 1,
        ...
        {
            name: 'Coconut Rice',
            description: 'Steamed rice tossed with freshly grated coconut & mustard seeds',
            price: 110,
            cat: 2,
        ...
        {
            name: 'Appam',
            description: 'Lacy fermented rice hoppers, best paired with stew or curry',
            price: 100,
            cat: 2,
            image: IMG.appam,
        },
        {
            name: 'Beans Poriyal',
            description: 'Green beans stir-fried with coconut, mustard seeds & curry leaves',
            price: 90,
            cat: 2,
            image: IMG.poriyal,
        },
        {
            name: 'Chutney Trio',
            description: 'Coconut, tomato & mint-coriander chutneys with fresh curry leaf oil',
            price: 60,
            cat: 2,
        ...
        {
            name: 'Semiya Payasam',
            description: 'Vermicelli simmered in milk, cardamom, cashews & golden raisins',
            price: 100,
            cat: 3,
            image: IMG.payasam,
        },
        {
            name: 'Carrot Halwa',
            description: 'Slow-cooked grated carrot in ghee, milk & khoya, topped with pistachios',
            price: 120,
            cat: 3,
            image: IMG.halwa,
        },
        {
            name: 'Kesari Bath',
            description: 'Semolina sweet with saffron, ghee & cardamom — a Bangalore classic',
            price: 90,
            cat: 3,
        ...
        {
            name: 'Mysore Pak',
            description: 'Melt-in-the-mouth gram flour & ghee fudge from the royal kitchens',
            price: 80,
            cat: 3,
            image: IMG.mysurePak,
        },
        ...
        },
        {
            ...
            description: 'Chilled churned curd with ginger, green chilli, coriander & mustard',
            price: 60,
            cat: 4,
        ...
        {
            name: 'Mango Lassi',
            description: 'Thick Alphonso mango blended with full-fat curd & a hint of saffron',
            price: 100,
            cat: 4,
        ...
        {
            name: 'Filter Coffee',
            description: 'Classic South Indian filter decoction with full-cream milk & froth',
            price: 70,
            cat: 4,
        ...
        {
            name: 'Panakam',
            description: 'Temple-style cold drink of jaggery, ginger, cardamom & pepper',
            price: 60,
            cat: 4,
            image: IMG.panakam,
        },
