...
describe('AuthService', () => {
    ...
    let usersService: jest.Mocked<Pick<UsersService, 'findByUserId' | 'updatePassword'>>;
    ...
    describe('validateUser', () => {
        it('returns the user when credentials are correct', async () => {
            ...
            usersService.findByUserId.mockResolvedValue({ ...mockUser, password_hash: hash });
    ...
    describe('login', () => {
        ...
        it('resolves restaurantId from direct field', () => {
            const result = service.login({ ...mockUser, restaurantId: 'rest-direct' });
        ...
        it('resolves restaurantId from outlet when not direct', () => {
            const user = { ...mockUser, restaurantId: null, outlet: { restaurantId: 'rest-via-outlet' } };
